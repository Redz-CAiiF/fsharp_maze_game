...
// ┌─────────────────────────────────────────────────────────────────────────┐
// │                                FUNCTION 
// │    NAME:          generate_row_cols
// │    DESCRIPTION:   genera una serie di celle basate sul predicato passato, 
// │                    gli indici delle celle vanno da (current_row,0,..) a 
// │                    (curren_row,coll_number-1,..)
// │    CREATOR:       ML
// │    OLD NAME:      generate_cols
// │
// └─────────────────────────────────────────────────────────────────────────┘
